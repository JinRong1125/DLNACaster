    ...
    throws IOException
    {
        ...
        else
        {
            ...
            if ( ranges.size()== 1)
            {
                ...
                long writeLength = singleSatisfiableRange.getFirst(content_length);
                resource.writeTo(out,writeLength,singleLength);
                SystemManager.Companion.getInstance().setSentLength(writeLength);
                return;
            }
